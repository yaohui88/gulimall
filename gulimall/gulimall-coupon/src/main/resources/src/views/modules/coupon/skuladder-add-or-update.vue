<template>
  <el-dialog
    ...
    <el-form-item label="?????" prop="fullCount">
      <el-input v-model="dataForm.fullCount" placeholder="?????"></el-input>
    </el-form-item>
    <el-form-item label="?????" prop="discount">
      <el-input v-model="dataForm.discount" placeholder="?????"></el-input>
    </el-form-item>
    <el-form-item label="?ۺ" prop="price">
      <el-input v-model="dataForm.price" placeholder="?ۺ"></el-input>
    </el-form-item>
    <el-form-item label="?Ƿ??????????Ż?[0-???ɵ??ӣ?1-?ɵ???]" prop="addOther">
      <el-input v-model="dataForm.addOther" placeholder="?Ƿ??????????Ż?[0-???ɵ??ӣ?1-?ɵ???]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          price: [
            { required: true, message: '?ۺ不能为空', trigger: 'blur' }
          ],
          addOther: [
            { required: true, message: '?Ƿ??????????Ż?[0-???ɵ??ӣ?1-?ɵ???]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
