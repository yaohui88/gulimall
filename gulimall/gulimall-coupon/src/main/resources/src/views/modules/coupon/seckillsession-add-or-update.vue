<template>
  <el-dialog
    ...
    <el-form-item label="ÿ?տ?ʼʱ?" prop="startTime">
      <el-input v-model="dataForm.startTime" placeholder="ÿ?տ?ʼʱ?"></el-input>
    </el-form-item>
    <el-form-item label="ÿ?ս???ʱ?" prop="endTime">
      <el-input v-model="dataForm.endTime" placeholder="ÿ?ս???ʱ?"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          startTime: [
            { required: true, message: 'ÿ?տ?ʼʱ?不能为空', trigger: 'blur' }
          ],
          endTime: [
            { required: true, message: 'ÿ?ս???ʱ?不能为空', trigger: 'blur' }
          ],
          status: [
