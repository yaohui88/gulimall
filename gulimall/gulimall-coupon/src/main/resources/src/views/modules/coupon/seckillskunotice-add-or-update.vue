<template>
  <el-dialog
    ...
    <el-form-item label="?????id" prop="sessionId">
      <el-input v-model="dataForm.sessionId" placeholder="?????id"></el-input>
    </el-form-item>
    <el-form-item label="????ʱ?" prop="subcribeTime">
      <el-input v-model="dataForm.subcribeTime" placeholder="????ʱ?"></el-input>
    </el-form-item>
    <el-form-item label="????ʱ?" prop="sendTime">
      <el-input v-model="dataForm.sendTime" placeholder="????ʱ?"></el-input>
    </el-form-item>
    <el-form-item label="֪ͨ??ʽ[0-???ţ?1-?ʼ" prop="noticeType">
      <el-input v-model="dataForm.noticeType" placeholder="֪ͨ??ʽ[0-???ţ?1-?ʼ"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          noticeType: [
            { required: true, message: '֪ͨ??ʽ[0-???ţ?1-?ʼ不能为空', trigger: 'blur' }
          ]
        }
      }
    },
